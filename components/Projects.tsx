    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 scrollbar-thin">
        {projects?.map((project, i) => (
          ...
          <div key={project._id} className="w-screen flex-shrink-0 snap-center flex flex-col space-y-10 items-center justify-center p-24 md:p-[300px] lg:p-[450px] h-screen ">
            <motion.img
            ...
            <div className=" space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <h4 className="text-sm font-bold flex items-center justify-center">
